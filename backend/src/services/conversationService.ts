...
export function createConversationContext(sessionId: string, resume: ParsedResume): ConversationContext {
...
export function addQuestionToContext(sessionId: string, question: string, answer: string): void {
...
function extractInitialInsights(resume: ParsedResume) {
...
function updateInsights(context: ConversationContext, question: string, answer: string): void {
...
export function getContextualPrompt(context: ConversationContext, resume: ParsedResume): string {
